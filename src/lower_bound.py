...
with open(f'src/training_runs/new_random_evaluation.csv', 'w') as f:
    writer = csv.writer(f)
    ...
    for model_class in model_list:
        ...
        lower_bound = model.evaluate(test_set, callbacks=[callback])

        writer.writerow([model.name] + lower_bound)
