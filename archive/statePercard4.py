...
model1.compile(
    ...
    loss=tf.keras.losses.BinaryFocalCrossentropy(gamma= 4,alpha=1),#from_logits=True),
    metrics = METRICS
)
model1.summary()
...
checkpoint_filepath = '/tmp/StateperCard4F_focal.h5'
...
csvLog = tf.keras.callbacks.CSVLogger("training_log_4F_StateperCard_focal.csv", 
                             separator=',', 
                             append=False)
...
#plt.show()
plt.savefig("StateperCard4F_focal.png")
