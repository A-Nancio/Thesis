...
def create_model(inputs):
    ...
    z3 = keras.layers.GRU(128, dropout=0.3, recurrent_regularizer='l2', stateful= False) (z, training=True)
    ...
    output3 = tf.keras.layers.Dense(24)(z3)
...
csvLog = tf.keras.callbacks.CSVLogger("training_log_2F_ResetState_v1.csv", 
                             separator=',', 
                             append=True)
...
plt.savefig("ResetState2_v1.png")
