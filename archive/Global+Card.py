...
class StatePerCard(keras.callbacks.Callback):
  ...
  """
    ...
    def on_batch_begin(self, batch, logs=None ):
        ...
        if self.customer in states_dict1:
    ...
    def on_batch_end(self, batch, logs=None):
        ...
        if isTest:
            ...
            if self.customer in states_dict1:
                ...
                print(np.array_equal(states_dict1[self.customer][0].numpy(),gru_layer1.states[0].numpy()))
                if np.array_equal(states_dict1[self.customer][0].numpy(),gru_layer1.states[0].numpy()):
                    print(gru_layer1.states)
                
                    print(states_dict1[self.customer])
...
checkpoint_filepath = '/tmp/StateperCard2F_v2.h5'
...
csvLog = tf.keras.callbacks.CSVLogger("training_log_2F_StateperCard_v2.csv", 
                             separator=',', 
                             append=False)
...
#plt.show()
plt.savefig("StateperCard2F_v2.png")
